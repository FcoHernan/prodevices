    ...
    function widget( $args, $instance ) {
        ...
        if ( $test_posts->have_posts() ) {
            ...
            while ( $test_posts->have_posts() ) {
                ...
                $out .= '<div class="testimonial-description arrow-down">';
                ...
                if ( has_post_thumbnail() ) {
                    $out .= '<div class="image-container">' . yit_image( "post_id=".get_the_ID()."&size=testimonial_thumb&output=img",false ) . '</div>';
                }
