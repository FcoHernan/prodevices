    ...
    while ( $tests->have_posts() ) : $tests->the_post();
        ...
        <div class="testimonial-col <?php echo $bootstrap_col_class ?>">
            <div class="testimonial-wrapper">
                ...
                <?php echo ( $role ) ? "<div class='role'>" . $role . "</div>" : ''; ?>


                <?php echo ( $website ) ? "<div class='text'>" . $website . "</div>" : ''; ?>
                ...
                <div class="testimonial-cit">
                    ...
                    <?php if ( $small_quote != '' ): ?>
                        <div class="testimonial-smallquote"><?php echo $small_quote ?></div>
                    <?php endif ?>
                ...
                <?php if ( $rating != 0 ): ?>
                    <div class="testimonial-rate">
                        <div class="testimonial-rating-label"><?php _e('Customer Rating', 'yit') ?></div>
