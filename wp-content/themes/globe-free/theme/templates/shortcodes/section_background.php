...
?>
<div class="section-background-outer section_fullwidth" style="min-height: <?php echo $height ?>px;">
    <div class="section-background <?php echo $animate ?>" data-height="<?php echo $height ?>" <?php echo $style.$delay; ?>></div>
</div>
