...
<style>
    ...
    #<?php echo $id ?>.box-title.bottom-little-line h2:after,
...
switch ( $border ):
    ...
    case 'middle':
        ?>
        <div id="<?php echo $id ?>" class="box-title box-title-text-<?php echo $font_alignment . $animate. ' '. $border ?> box-title-line-middle wrap-title <?php echo ( isset( $class ) ) ? $class : '' ?>" <?php echo $delay ?>>
            <div class="title-bar">
    ...
    case 'bottom':
        ?>
        <div id="<?php echo $id ?>" class="box-title box-title-text-<?php echo $font_alignment  . $animate ?> box-title-line-bottom <?php echo ( isset( $class ) ) ? $class : '' ?>" <?php echo $delay ?>>
            <h2 style="<?php echo $title_style ?>">
                <?php echo yit_decode_title ( do_shortcode( $content ) )?>    
            </h2>
            <?php if( $subtitle != '' ):?>
    ...
    case 'around':
        ?>
        <div id="<?php echo $id ?>" class="box-title box-title-text-<?php echo $font_alignment  . $animate ?> box-title-line-around wrap-title <?php echo ( isset( $class ) ) ? $class : '' ?>" <?php echo $delay ?>>
            <div class="title-bar">
                <h2 style="<?php echo $title_style ?>">
                    <?php echo yit_decode_title( do_shortcode( $content ) ) ?>
                </h2>
    ...
    default:
        ?>
        <div id="<?php echo $id ?>" class="box-title box-title-text-<?php echo $font_alignment . $animate . ' ' . $border ?> box-title-line-none <?php echo ( isset( $class ) ) ? $class : '' ?>" <?php echo $delay ?>>
            <h2 style="<?php echo $title_style ?>">
                <?php echo yit_decode_title( do_shortcode( $content ) ) ?>
            </h2>
            <?php if( $subtitle != '' ):?>
