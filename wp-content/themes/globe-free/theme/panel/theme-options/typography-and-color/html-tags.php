...
return array(
    ...
    array(
        ...
        'style' => array(
            'selectors'   => 'h1, .cta-phone .cta-phone-phone, .call-to-action-two .call-to-action-two-container div.incipit span,
    ...
    array(
        ...
        'style' => array(
            'selectors'   => 'h2, .teaser-wrapper .image_banner_text p.title, .call-three .newsletter-cta-form-container span.newsletter-cta-incipit',
            'properties'  => 'font-size,
                              font-family,
                              font-weight,
                              color,
    ...
    array(
        ...
        'style' => array(
            'selectors'   => 'h3, .testimonial-wrapper .testimonial-name .name,
