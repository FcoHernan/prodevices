...
function yit_global_object() {
    ...
    wp_localize_script( 'jquery', 'yit', array(
        ...
        'added_to_cart_text' => __( 'Added to cart', 'yit' ),
        'general_layout_type' => yit_get_option( 'general-layout-type' ),
        'single_image_width' => function_exists( 'yit_shop_single_w' ) ? yit_shop_single_w() : false,
...
return array(
    ...
    'style'  => array(
        ...
        'font-simple-line-icons' => array(
            'src'       => YIT_THEME_ASSETS_URL . '/fonts/Simple-Line-Icons-Webfont/simple-line-icons.css',
            'enqueue'   => true
        ),
        ...
        'typography-and-colors' => array(
            'src'       => YIT_THEME_ASSETS_URL . '/css/typography-and-colors.css',
            'enqueue'   => true
        ),
		'responsive' => array(
    ...
    'script' => array(
        ...
        'yit-internal' => array(
            ...
            'enqueue'   => true,
            'deps'      => array('jquery'),
            'localize'  => array('search_button' =>  __( 'GO' , 'yit' ) ),
        ),
